...
static const ssl_trace_tbl ssl_exts_tbl[] = {
    ...
    {TLSEXT_TYPE_key_share_pqc, "key_share_pqc"},
    {TLSEXT_TYPE_psk_kex_modes_pqc, "psk_kex_modes_pqc"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_START
    ...
    {OQS_KEM_CURVEID(NID_rlcel1), "rlcel1"},
    {OQS_KEM_CURVEID(NID_rlcel3), "rlcel3"},
    {OQS_KEM_CURVEID(NID_rlcel5), "rlcel5"},
    {OQS_KEM_CURVEID(NID_classicmceliece348864), "classicmceliece348864"},
    {OQS_KEM_CURVEID(NID_classicmceliece348864f), "classicmceliece348864f"},
    {OQS_KEM_CURVEID(NID_classicmceliece460896), "classicmceliece460896"},
    {OQS_KEM_CURVEID(NID_classicmceliece460896f), "classicmceliece460896f"},
    {OQS_KEM_CURVEID(NID_classicmceliece6688128), "classicmceliece6688128"},
    {OQS_KEM_CURVEID(NID_classicmceliece6688128f), "classicmceliece6688128f"},
    {OQS_KEM_CURVEID(NID_classicmceliece6960119), "classicmceliece6960119"},
    {OQS_KEM_CURVEID(NID_classicmceliece6960119f), "classicmceliece6960119f"},
    {OQS_KEM_CURVEID(NID_classicmceliece8192128), "classicmceliece8192128"},
    {OQS_KEM_CURVEID(NID_classicmceliece8192128f), "classicmceliece8192128f"},
...
///// OQS_TEMPLATE_FRAGMENT_SSL_GROUPS_TBL_HYBRID_START
    ...
    {OQS_KEM_CURVEID(NID_p256_rlcel1), "p256 - rlcel1 hybrid"},
    {OQS_KEM_CURVEID(NID_p384_rlcel3), "p384 - rlcel3 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_rlcel5), "p521 - rlcel5 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece348864), "p256 - classicmceliece348864 hybrid"},
    {OQS_KEM_CURVEID(NID_p256_classicmceliece348864f), "p256 - classicmceliece348864f hybrid"},
    {OQS_KEM_CURVEID(NID_p384_classicmceliece460896), "p384 - classicmceliece460896 hybrid"},
    {OQS_KEM_CURVEID(NID_p384_classicmceliece460896f), "p384 - classicmceliece460896f hybrid"},
    {OQS_KEM_CURVEID(NID_p521_classicmceliece6688128), "p521 - classicmceliece6688128 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_classicmceliece6688128f), "p521 - classicmceliece6688128f hybrid"},
    {OQS_KEM_CURVEID(NID_p521_classicmceliece6960119), "p521 - classicmceliece6960119 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_classicmceliece6960119f), "p521 - classicmceliece6960119f hybrid"},
    {OQS_KEM_CURVEID(NID_p521_classicmceliece8192128), "p521 - classicmceliece8192128 hybrid"},
    {OQS_KEM_CURVEID(NID_p521_classicmceliece8192128f), "p521 - classicmceliece8192128f hybrid"},
